...
public enum EEVeraReferenceIndex {
    ...
    public static let entries: [EEVeraCitation] = [
        ...
        .init(id: "nec-409", source: .nec, citation: "NEC Article 409",
              ...
              domains: [.electrical, .instrumentation, .plcAutomation], keywords: ["control panel", "sccr", "short circuit current rating"]),
        .init(id: "nfpa-79", source: .industryStandard, citation: "NFPA 79",
              summary: "Electrical standard for industrial machinery: control-circuit design, disconnecting means, interlocking, emergency stop, and protective wiring requirements for machine control systems — the standard that actually governs a PLC/relay control panel's electrical design, distinct from the NEC's general installation rules.",
              domains: [.plcAutomation, .electrical, .rotatingEquipment], keywords: ["machine control", "emergency stop", "control circuit", "interlock", "nfpa 79"]),
        ...
        .init(id: "osha-1910.147", source: .osha, citation: "29 CFR 1910.147",
              ...
              domains: [.electrical, .instrumentation, .rotatingEquipment, .coalMining, .processSafety, .plcAutomation], keywords: ["loto", "lockout tagout", "energy control program", "authorized employee"]),
        ...
        .init(id: "nfpa70e-120", source: .nfpa70E, citation: "NFPA 70E Article 120",
              ...
              domains: [.electrical, .instrumentation, .rotatingEquipment, .processSafety, .plcAutomation], keywords: ["loto", "lockout", "tagout", "electrically safe work condition", "esw"]),
