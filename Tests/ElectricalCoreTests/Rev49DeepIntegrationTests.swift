...
@Suite("Rev49 deep integration") struct Rev49DeepIntegrationTests {
 ...
 @Test func roundTrip() throws {let m=EERev49DeepIntegration();let d=try JSONEncoder().encode(m);let r=try JSONDecoder().decode(EERev49DeepIntegration.self,from:d);#expect(r == m)}
}
